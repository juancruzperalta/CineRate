...
export const UserButtons = ({serieId, mediaType}) => {
  ...
  return (
    <div className='flex w-full justify-between p-2 bg-black/85 gap-4 mt-4 lg:mt-0'>
      <button disabled={!isLogged} onClick={() => favoriteButton(serieId, mediaType)} className={`flex items-center justify-start w-full cursor-pointer`}>
      ...
      <span  onClick={()=> buttonWatchLater(serieId, mediaType)}  className={`flex items-center justify-start  w-full cursor-pointer`}>
