...
export const UserButtons = ({serieId, mediaType}) => {
  ...
  return (
    <div className='grid grid-cols-2 md:flex lg:absolute mt-4 mb-2 lg:mt-0 bottom-1 z-10 items-center justify-center lg:justify-start md:gap-4 w-full text-sm md:text-md lg:text-lg'>
      <button disabled={!isLogged} onClick={() => favoriteButton(serieId, mediaType)} className={`flex items-center justify-start w-[140px] cursor-pointer`}>
      ...
      <span  onClick={()=> buttonWatchLater(serieId, mediaType)}  className={`flex items-center justify-start  w-[140px] cursor-pointer`}>
