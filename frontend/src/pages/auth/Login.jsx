...
export const Login = () => {
  ...
  return (
    <div className='px-10 text-2xl font-bold bg-[radial-gradient(circle,_rgba(14,211,149,0.45)_1%,_rgba(14,211,149,0.2)_5%,_rgba(12,61,47,0.35)_15%,_rgba(0,0,0,1)_100%)] w-full h-screen flex flex-col items-center justify-center'>
      UPDATING THE AUTH AND REGISTER
    </div>
    ...
    //   <form action="" className='flex items-center justify-center flex-col gap-3 bg-[#272b2f]/85 rounded-xl shadow-sm shadow-gray-900 py-8 px-6 h-full w-full md:min-w-[340px] relative'>
