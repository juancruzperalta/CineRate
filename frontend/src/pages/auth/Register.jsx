...
export const Register = () => {
  ...
  return (
      ...
      <form action="" className='flex items-center justify-center flex-col gap-3 bg-[#272b2f] rounded-xl shadow-sm shadow-gray-900 py-8 px-6 h-full w-full md:min-w-[340px] relative'>
        ...
        <input type="button" value="register" placeholder='Register' className='bg-white w-full rounded-sm p-2 text-black uppercase font-semibold text-[0.9rem] disabled:opacity-80 cursor-pointer' onClick={() => {confirmEquals("register", email) }}  />
       ...
       <span className={`${Loading ? 'flex' : 'hidden'}`}><svg className="animate-spin text-green" width="48" height="48" viewBox="0 0 50 50"><circle
          cx="25"   cy="25" r="20" fill="none" stroke="#0ed395" strokeWidth="4" strokeLinecap="round" strokeDasharray="90 150"/>
      </svg></span>
