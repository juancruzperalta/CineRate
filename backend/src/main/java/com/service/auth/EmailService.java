...
public class EmailService {
 ...
 public EmailService(@Value("${resend.api.key}") String apiKey,UserRepository repo, RateLimitSecurity rateLimit) {
        this.repo = repo;
            ...
            <tr>
              <td align="center" style="padding-top:25px;">
                ...
                <p style="font-size:12px;color:#888;word-break:break-all;">
                  https://cine-rate.site/auth/register/confirm?token=%s
                </p>
              </td>
            </tr>
